...
#define log_trace(...) log_base_(LOG_TRACE, __FILE__, __LINE__, __VA_ARGS__)
#define log_debug(...) log_base_(LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__)
#define log_info(...)  log_base_(LOG_INFO,  __FILE__, __LINE__, __VA_ARGS__)
#define log_warn(...)  log_base_(LOG_WARN,  __FILE__, __LINE__, __VA_ARGS__)
#define log_error(...) log_base_(LOG_ERROR,   __FILE__, __LINE__, __VA_ARGS__)
#define log_wtf(...)   log_base_(LOG_WTF,   __FILE__, __LINE__, __VA_ARGS__)
